...
Tipos para elegir el nombre del negocio:
- Un nombre corto y sencillo de pronunciar
- Dominio disponible
...
Tasks
- buscar nombre, algo corto.com
- me gusta el estilo de la pagina de buy domain de vercel
- Logo, podemos buscar algo como redit
- pantalla blanca de la notebook, podemos probar de ponerle algo o mejor no
...
Notas
- Razon importante del proyecto: organizacion 
- menu: 
    inicio 
    ...
    servicios
    blog
    recomendaciones de creadores de contenido
    stack tecnologico
