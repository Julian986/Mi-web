      ...
      <div className="min-h-screen overflow-x-hidden text-slate-900">
        ...
        <section id="contact" className="border-t border-black/10 px-6 py-16 text-center overflow-x-hidden scroll-mt-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="mailto:glomunsoftware@gmail.com"
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#25D366] px-6 py-2.5 font-medium text-white transition-colors hover:bg-[#20BA5A]"
            >
              <svg
                width="20"
                height="20"
